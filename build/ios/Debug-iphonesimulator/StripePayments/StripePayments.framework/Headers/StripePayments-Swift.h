...
/// seealso:
/// <a href="https://stripe.com/docs/api#create_bank_account_token">Stripe API reference</a>
/// \param bankAccount The user’s bank account details.
///
/// \param completion The callback to run with the returned Stripe token (and any errors that may have occurred).
///
...
/// seealso:
/// <a href="https://stripe.com/docs/api#create_pii_token">Stripe API reference</a>
/// \param ssnLast4 The last 4 digits of the user’s SSN.
///
/// \param completion The callback to run with the returned Stripe token (and any errors that may have occurred).
///
...
/// seealso:
/// <a href="https://stripe.com/docs/api#create_card_token">Stripe API reference</a>
/// \param cardParams The user’s card details.
///
/// \param completion The callback to run with the returned Stripe token (and any errors that may have occurred).
///
...
/// seealso:
/// <a href="https://stripe.com/docs/api#create_source">Stripe API reference</a>
/// seealso:
/// <a href="https://stripe.com/docs/sources/connect#creating-direct-charges">Creating direct charges on connected accounts</a>
/// \param sourceParams The details of the source to create.
///
...
/// seealso:
/// <a href="https://stripe.com/docs/api#retrieve_source">Stripe API reference</a>
/// \param identifier The identifier of the source to be retrieved.
///
/// \param secret The client secret of the source.
///
/// \param completion The callback to run with the returned Source object, or an error.
///
...
/// seealso:
/// <a href="https://stripe.com/docs/api/payment_methods/create">Stripe API reference</a>
/// \param paymentMethodParams The <code>STPPaymentMethodParams</code> to pass to <code>/v1/payment_methods</code>.
///
...
@class NSNumber;
@class STPPaymentIntentConfirmParams;
@interface STPAPIClient (SWIFT_EXTENSION(StripePayments))
/// Retrieves the PaymentIntent object using the given secret.
/// seealso:
/// [Stripe API reference](https://stripe.com/docs/api#retrieve_payment_intent]
/// \param secret The client secret of the payment intent to be retrieved.
///
...
/// \param secret The client secret of the payment intent to be retrieved.
///
/// \param expand An array of string keys to expand on the returned PaymentIntent object. These strings should match one or more of the parameter names that are marked as expandable.
///
/// \param completion The callback to run with the returned PaymentIntent object, or an error.
///
...
- (void)retrievePaymentIntentWithClientSecret:(NSString * _Nonnull)secret expand:(NSArray<NSString *> * _Nullable)expand timeout:(NSNumber * _Nullable)timeout completion:(void (^ _Nonnull)(STPPaymentIntent * _Nullable, NSError * _Nullable))completion;
...
/// note:
/// Use the <code>confirmPayment:withAuthenticationContext:completion:</code> method on <code>STPPaymentHandler</code> instead
/// of calling this method directly. It handles any authentication necessary for you.
/// seealso:
/// <a href="https://stripe.com/docs/api#confirm_payment_intent">Stripe API reference</a>
/// \param paymentIntentConfirmParams The <code>STPPaymentIntentConfirmParams</code> to pass to <code>/confirm</code>
///
/// \param completion The callback to run with the returned PaymentIntent object, or an error.
///
- (void)confirmPaymentIntentWithParams:(STPPaymentIntentConfirmParams * _Nonnull)paymentIntentConfirmParams completion:(void (^ _Nonnull)(STPPaymentIntent * _Nullable, NSError * _Nullable))completion;
/// Confirms the PaymentIntent object with the provided params object.
/// At a minimum, the params object must include the <code>clientSecret</code>.
/// note:
/// Use the <code>confirmPayment:withAuthenticationContext:completion:</code> method on <code>STPPaymentHandler</code> instead
...
/// <a href="https://stripe.com/docs/api#confirm_payment_intent">Stripe API reference</a>
/// seealso:
/// <a href="https://stripe.com/docs/api/payment_intents/object">Stripe API reference</a>
/// \param paymentIntentConfirmParams The <code>STPPaymentIntentConfirmParams</code> to pass to <code>/confirm</code>
///
/// \param expand An array of string keys to expand on the returned PaymentIntent object. These strings should match one or more of the parameter names that are marked as expandable.
///
/// \param completion The callback to run with the returned PaymentIntent object, or an error.
///
- (void)confirmPaymentIntentWithParams:(STPPaymentIntentConfirmParams * _Nonnull)paymentIntentConfirmParams expand:(NSArray<NSString *> * _Nullable)expand completion:(void (^ _Nonnull)(STPPaymentIntent * _Nullable, NSError * _Nullable))completion;
@end
...
/// seealso:
/// <a href="https://stripe.com/docs/api/setup_intents/retrieve">Stripe API reference</a>
/// seealso:
/// <a href="https://stripe.com/docs/api/setup_intents/object">Stripe API reference</a>
/// \param secret The client secret of the SetupIntent to be retrieved.
///
/// \param expand An array of string keys to expand on the returned SetupIntent object. These strings should match one or more of the parameter names that are marked as expandable.
///
/// \param completion The callback to run with the returned SetupIntent object, or an error.
///
...
/// At a minimum, the params object must include the <code>clientSecret</code>.
/// note:
/// Use the <code>confirmSetupIntent:withAuthenticationContext:completion:</code> method on <code>STPPaymentHandler</code> instead
/// of calling this method directly. It handles any authentication necessary for you.
/// seealso:
/// <a href="https://stripe.com/docs/api/setup_intents/confirm">Stripe API reference</a>
...
/// seealso:
/// https://stripe.com/docs/api/confirmation_tokens
SWIFT_CLASS("_TtC14StripePayments33STPConfirmationTokenClientContext")
@interface STPConfirmationTokenClientContext : NSObject <STPFormEncodable>
@property (nonatomic, copy) NSDictionary * _Nonnull additionalAPIParameters;
...
@property (nonatomic, copy) NSString * _Nullable setupFutureUsage;
/// Controls when the funds will be captured (payment mode only)
@property (nonatomic, copy) NSString * _Nullable captureMethod;
/// The payment method types for the intent
@property (nonatomic, copy) NSArray<NSString *> * _Nullable paymentMethodTypes;
...
@property (nonatomic, copy) NSString * _Nullable paymentMethodConfiguration;
/// Customer ID
@property (nonatomic, copy) NSString * _Nullable customer;
/// Payment method specific options as a dictionary
@property (nonatomic, copy) NSDictionary<NSString *, id> * _Nullable paymentMethodOptions;
/// :nodoc:
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
+ (NSString * _Nullable)rootObjectName SWIFT_WARN_UNUSED_RESULT;
+ (NSDictionary<NSString *, NSString *> * _Nonnull)propertyNamesToFormFieldNamesMapping SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic, strong) STPConfirmationTokenClientContext * _Nullable clientContext;
/// :nodoc:
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
+ (NSString * _Nullable)rootObjectName SWIFT_WARN_UNUSED_RESULT;
+ (NSDictionary<NSString *, NSString *> * _Nonnull)propertyNamesToFormFieldNamesMapping SWIFT_WARN_UNUSED_RESULT;
...
/// Confirms the PaymentIntent using the provided <code>params</code> and handles any next actions required to authenticate the PaymentIntent.
/// note:
/// If the status returned is <code>STPPaymentHandlerActionStatus.succeeded</code>, the PaymentIntent status is not necessarily <code>STPPaymentIntentStatus.succeeded</code> (e.g. some bank payment methods take days before money moves and the PaymentIntent succeeds).
/// \param params The params used to confirm the PaymentIntent. Note that this method overrides the value of <code>paymentParams.useStripeSDK</code> to <code>@YES</code>.
///
/// \param authenticationContext The authentication context used to authenticate the payment.
///
/// \param completion The completion block.
///
- (void)confirmPaymentIntentWithParams:(STPPaymentIntentConfirmParams * _Nonnull)params authenticationContext:(id <STPAuthenticationContext> _Nonnull)authenticationContext completion:(void (^ _Nonnull)(enum STPPaymentHandlerActionStatus, STPPaymentIntent * _Nullable, NSError * _Nullable))completion;
...
/// note:
/// If the status returned is <code>STPPaymentHandlerActionStatus.succeeded</code>, the SetupIntent status will always be <code>STPSetupIntentStatus.succeeded</code>.
/// \param params The params used to confirm the SetupIntent. Note that this method overrides the value of <code>setupIntentConfirmParams.useStripeSDK</code> to <code>@YES</code>.
///
/// \param authenticationContext The authentication context used to authenticate the SetupIntent.
///
/// \param completion The completion block called when this method is finished.
///
- (void)confirmSetupIntentWithParams:(STPSetupIntentConfirmParams * _Nonnull)params authenticationContext:(id <STPAuthenticationContext> _Nonnull)authenticationContext completion:(void (^ _Nonnull)(enum STPPaymentHandlerActionStatus, STPSetupIntent * _Nullable, NSError * _Nullable))completion;
...
@interface STPPaymentHandler (SWIFT_EXTENSION(StripePayments))
- (void)confirmPayment:(STPPaymentIntentConfirmParams * _Nonnull)paymentParams withAuthenticationContext:(id <STPAuthenticationContext> _Nonnull)authenticationContext completion:(void (^ _Nonnull)(enum STPPaymentHandlerActionStatus, STPPaymentIntent * _Nullable, NSError * _Nullable))completion SWIFT_DEPRECATED_MSG("", "confirmPaymentIntentWithParams:authenticationContext:completion:");
- (void)confirmSetupIntent:(STPSetupIntentConfirmParams * _Nonnull)setupIntentConfirmParams withAuthenticationContext:(id <STPAuthenticationContext> _Nonnull)authenticationContext completion:(void (^ _Nonnull)(enum STPPaymentHandlerActionStatus, STPSetupIntent * _Nullable, NSError * _Nullable))completion SWIFT_DEPRECATED_MSG("", "confirmSetupIntentWithParams:authenticationContext:completion:");
- (void)handleNextActionForPayment:(NSString * _Nonnull)paymentIntentClientSecret withAuthenticationContext:(id <STPAuthenticationContext> _Nonnull)authenticationContext returnURL:(NSString * _Nullable)returnURL completion:(void (^ _Nonnull)(enum STPPaymentHandlerActionStatus, STPPaymentIntent * _Nullable, NSError * _Nullable))completion SWIFT_DEPRECATED_MSG("", "handleNextAction(paymentIntentClientSecret:authenticationContext:completion:)");
- (void)handleNextActionForSetupIntent:(NSString * _Nonnull)setupIntentClientSecret withAuthenticationContext:(id <STPAuthenticationContext> _Nonnull)authenticationContext returnURL:(NSString * _Nullable)returnURL completion:(void (^ _Nonnull)(enum STPPaymentHandlerActionStatus, STPSetupIntent * _Nullable, NSError * _Nullable))completion SWIFT_DEPRECATED_MSG("", "handleNextAction(setupIntentClientSecret:authenticationContext:completion:)");
@end
...
/// The payment method requires a return URL and one was not provided. Your integration should provide one in your <code>STPPaymentIntentConfirmParams</code>/<code>STPSetupIntentConfirmParams</code> object if you call <code>STPPaymentHandler.confirm...</code> or when you call  <code>STPPaymentHandler.handleNextAction</code>.
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC14StripePayments29STPPaymentIntentConfirmParams")
@interface STPPaymentIntentConfirmParams : NSObject
/// Initialize this <code>STPPaymentIntentConfirmParams</code> with a <code>clientSecret</code>, which is the only required
/// field.
...
/// Initializes this <code>STPPaymentIntentConfirmParams</code> with a <code>clientSecret</code> and <code>paymentMethodType</code>.
...
@property (nonatomic, copy) NSString * _Nullable confirmationToken;
/// The URL to redirect your customer back to after they authenticate or cancel
/// their payment on the payment method’s app or site.
...
@interface STPPaymentIntentConfirmParams (SWIFT_EXTENSION(StripePayments)) <NSCopying>
/// :nodoc:
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end

@interface STPPaymentIntentConfirmParams (SWIFT_EXTENSION(StripePayments)) <STPFormEncodable>
+ (NSString * _Nullable)rootObjectName SWIFT_WARN_UNUSED_RESULT;
+ (NSDictionary<NSString *, NSString *> * _Nonnull)propertyNamesToFormFieldNamesMapping SWIFT_WARN_UNUSED_RESULT;
@end
...
/// This PaymentIntent needs to be confirmed
  STPPaymentIntentStatusRequiresConfirmation = 2,
...
/// Additional actions found via <code>next_action</code>
  STPPaymentIntentStatusRequiresAction = 3,
/// Stripe is processing this PaymentIntent
  STPPaymentIntentStatusProcessing = 4,
/// The payment has succeeded
  STPPaymentIntentStatusSucceeded = 5,
/// Indicates the payment must be captured, for STPPaymentIntentCaptureMethodManual
  STPPaymentIntentStatusRequiresCapture = 6,
/// This PaymentIntent was canceled and cannot be changed.
  STPPaymentIntentStatusCanceled = 7,
};
...
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
/// :nodoc:
- (nonnull instancetype)initWithStripeId:(NSString * _Nonnull)stripeId created:(NSDate * _Nonnull)created type:(enum STPPaymentMethodType)type allowRedisplay:(enum STPPaymentMethodAllowRedisplay)allowRedisplay OBJC_DESIGNATED_INITIALIZER;
+ (nullable instancetype)decodedObjectFromAPIResponse:(NSDictionary * _Nullable)response SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// A Przelewy24 Debit payment method.
  STPPaymentMethodTypePrzelewy24 = 9,
/// An EPS payment method.
  STPPaymentMethodTypeEPS SWIFT_COMPILE_NAME("EPS") = 10,
/// A Bancontact payment method.
  STPPaymentMethodTypeBancontact = 11,
/// A NetBanking payment method.
  STPPaymentMethodTypeNetBanking = 12,
/// An OXXO payment method.
  STPPaymentMethodTypeOXXO SWIFT_COMPILE_NAME("OXXO") = 13,
/// A UPI payment method.
  STPPaymentMethodTypeUPI = 14,
/// A PayPal payment method. :nodoc:
  STPPaymentMethodTypePayPal = 15,
/// An AfterpayClearpay payment method
  STPPaymentMethodTypeAfterpayClearpay = 16,
/// A BLIK payment method
  STPPaymentMethodTypeBLIK SWIFT_COMPILE_NAME("blik") = 17,
/// A WeChat Pay payment method
  STPPaymentMethodTypeWeChatPay = 18,
/// A Boleto payment method.
  STPPaymentMethodTypeBoleto = 19,
/// A Link payment method
  STPPaymentMethodTypeLink = 20,
/// A Klarna payment method.
  STPPaymentMethodTypeKlarna = 21,
/// An Affirm payment method
  STPPaymentMethodTypeAffirm = 22,
/// A US Bank Account payment method (ACH)
  STPPaymentMethodTypeUSBankAccount = 23,
/// A CashApp payment method
  STPPaymentMethodTypeCashApp = 24,
/// A PayNow payment method
  STPPaymentMethodTypePaynow = 25,
/// A Zip payment method
  STPPaymentMethodTypeZip = 26,
/// A RevolutPay payment method
  STPPaymentMethodTypeRevolutPay = 27,
/// An AmazonPay payment method
  STPPaymentMethodTypeAmazonPay = 28,
/// An Alma payment method
  STPPaymentMethodTypeAlma = 29,
/// A Sunbit payment method
  STPPaymentMethodTypeSunbit = 30,
/// A Billie payment method
  STPPaymentMethodTypeBillie = 31,
/// A Satispay payment method
  STPPaymentMethodTypeSatispay = 32,
/// A Crypto payment method
  STPPaymentMethodTypeCrypto = 33,
/// A MobilePay payment method
  STPPaymentMethodTypeMobilePay = 34,
/// A Konbini payment method
  STPPaymentMethodTypeKonbini = 35,
/// A PromptPay payment method
  STPPaymentMethodTypePromptPay = 36,
/// A Swish payment method
  STPPaymentMethodTypeSwish = 37,
/// A TWINT payment method
  STPPaymentMethodTypeTwint = 38,
/// A Multibanco payment method
  STPPaymentMethodTypeMultibanco = 39,
/// A ShopPay payment method
  STPPaymentMethodTypeShopPay = 40,
/// An unknown type.
...
/// Last four digits of the bank account number
@property (nonatomic, readonly, copy) NSString * _Nonnull last4;
@property (nonatomic, readonly, copy) NSString * _Nullable linkedAccount SWIFT_DEPRECATED_MSG("", "financialConnectionsAccount");
/// The ID of the Financial Connections Account used to create the payment method
@property (nonatomic, readonly, copy) NSString * _Nullable financialConnectionsAccount;
...
@property (nonatomic, copy) NSDictionary<NSString *, NSString *> * _Nullable iosVerificationObject;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
